...
import { Star, BadgeCheck, Globe, Truck, ShieldCheck, Zap, CreditCard as CardIcon, Bitcoin, Wallet } from 'lucide-react';
  ...
  <footer className="relative z-10 pt-20 md:pt-32 pb-10 md:pb-16 border-t border-white/5 bg-black/40 backdrop-blur-xl mt-20 md:mt-32 text-white font-jakarta">
    <div className="container mx-auto px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12 text-slate-400 text-xs mb-12 md:mb-20 text-center md:text-left">
        ...
        <div><h5 className="text-blue-400 font-black italic uppercase mb-4 md:mb-6 tracking-widest">{t('Pagamento Seguro', 'Secure Payment')}</h5><div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 items-center"><div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-md border border-white/10 text-white font-bold"><Zap size={14} className="text-[#32b1a4]" /><span className="text-[9px] font-black text-[#32b1a4]">PIX</span></div><div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-md border border-white/10 text-white font-bold"><CardIcon size={14} className="text-blue-400" /><span className="text-[9px] font-black text-blue-400">CARD</span></div><div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-md border border-white/10 text-white font-bold"><Bitcoin size={14} className="text-yellow-500" /><span className="text-[9px] font-black text-yellow-500">BTC</span></div><div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-md border border-white/10 text-white font-bold"><Wallet size={14} className="text-blue-500" /><span className="text-[9px] font-black text-blue-500">PAYPAL</span></div></div></div>
